                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?=$komplain->teknisi_nama;?></td>
                                        <td><?=$komplain->tgl_komplain;?></td>
                                        <td><?=$komplain->no_tlpn;?></td>
                                        <td><?=$komplain->isikomplain;?></td>
                                        <td style="text-align: center;">
                                            <a href="<?=site_url('master/C_Master/delete_komplain/'.$komplain->komplain_id);?>" onClick="return doconfirm();"><i class="fa fa-trash fa-fw" style="color: red;"></i></a>
                                        </td>
                                    </tr>
                                    <?php $no++; } ?>
                                </tbody>
