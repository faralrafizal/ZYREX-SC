...
<?php $this->load->view('master/Va_Navbar');?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <br><h2 class="page-header">Welcome <b><?php echo $this->session->userdata('master_user') ?></b></h2> 
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row" id="panel-cta">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div class="panel-heading-text">master Registered</div>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo site_url('master/C_Master/read_master');?>">
               ...
               <div class="col-lg-3 col-md-6">
                    <div class="panel">
                        ...
                        <a href="<?php echo site_url('master/C_Master/read_servis');?>">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
               ...
               <div class="col-lg-3 col-md-6">
                    <div class="panel">
                        ...
                        <a href="<?php echo site_url('master/C_Master/read_komplain');?>">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
