                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <!-- /.col-lg-6 (nested) -->                                
                                <div class="col-lg-6">
                                    <?php echo form_open("master/C_Master/update_perusahaan"); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="perusahaan_no_1" value="<?=$data_perusahaan->perusahaan_no_1; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">No Kontak 2 <span class="red">*</span></label>
                                            <input type="text" name="perusahaan_no_2" value="<?=$data_perusahaan->perusahaan_no_2; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="perusahaan_link" value="<?=$data_perusahaan->perusahaan_link; ?>" class="form-control">
                                        </div>
                                        <div class="form-group">
