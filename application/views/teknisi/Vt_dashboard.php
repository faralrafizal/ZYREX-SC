...
<?php $this->load->view('teknisi/Vt_Navbar');?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <br><h2 class="page-header">Welcome <?php echo $this->session->userdata('teknisi_user'); ?></h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row" id="panel-cta">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div class="panel-heading-text">Profil</div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="panel">
                        ...
                        <a href="<?php echo site_url('teknisi/C_Teknisi/read_servis');?>">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                 ...
                 <div class="col-lg-3 col-md-6">
                    <div class="panel">
                        <div class="panel-heading">
                            <div class="row">
                                <div class="col-xs-3">
                                    <i class="glyphicon glyphicon-share fa-5x orange"></i>
                                </div>
                                <div class="col-xs-9 text-right">
                                   
                                    <div class="huge"></div>
                                    
                                    <div class="panel-heading-text">Transaksi Servis</div>
                                </div>
                            </div>
                        </div>
