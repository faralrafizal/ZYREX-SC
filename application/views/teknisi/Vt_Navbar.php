        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('teknisi/C_Teknisi');?>">Backoffice Inventory Servis</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <li>
                            <a href="<?php echo site_url('teknisi/C_Teknisi/pengembalian_barang');?>"><i class="glyphicon glyphicon-share"></i> Tindakan Servis</a>
                        </li>
                        <li>
