...
<?php $this->load->view('pm/Vm_Navbar');?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="<?php echo site_url('pm/C_Pm/create_customer');?>" class="btn btn-primary">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center;">
                                            <a href="<?=site_url('pm/C_Pm/zoom_customer/'.$customer->customer_id);?>"><i class="fa fa-search fa-fw" style="color: black;"></i></a>
                                            &nbsp;|&nbsp;
                                            <a href="<?=site_url('pm/C_Pm/edit_customer/'.$customer->customer_id);?>"><i class="fa fa-edit fa-fw" style="color: blue;"></i></a>
                                            &nbsp;|&nbsp;
                                            <?php  
                                            ...
                                            <?php  /*
                                            <a href="<?=site_url('pm/C_Pm/delete_customer/'.$customer->customer_id);?>" onClick="return doconfirm();"><i class="fa fa-trash fa-fw" style="color: red;"></i></a>
                                            */ ?>
                                        </td>
                                    </tr>
                                    <?php $no++; } ?>
