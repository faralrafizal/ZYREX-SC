        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?php echo site_url('pm/C_Pm');?>">Backoffice Inventory Servis</a>
            </div>
            <!-- /.navbar-header -->
         ...
         <!-- /.nav-second-level -->
                        ...
                        <li>
                            <a href="<?php echo site_url('pm/C_Pm/read_customer');?>"><i class="fa fa-users"></i> Data Customer</a>
                        </li>
                        <li>
